...
module.exports = function(XRegExp) {
     ...
     *   minutes: /^[0-5][0-9]$/
     * });
     * time.tests--functional('10:59'); // -> true
...
module.exports = function(XRegExp) {
     ...
     *   bmp: '0-9A-Fa-f'
     * }]);
     * XRegExp('\\p{XDigit}:\\p{Hexadecimal}+').tests--functional('0:3D'); // -> true
     */
...
function runTokens(pattern, flags, pos, scope, context) {
    ...
    while (i--) {
        ...
        if (match) {
            ...
            // Finished with token tests--functional
            break;
        }
    }
...
// Intentionally undocumented; used in tests--functional and addons
...
// Intentionally undocumented; used in tests--functional
 ...
 * `RegExp.prototype.tests--functional` and can be used reliably cross-browser.
 *
 * @memberOf XRegExp
 * @param {String} str String to search.
 * @param {RegExp} regex Regex to search with.
 ...
 *
 * // Basic use
 * XRegExp.tests--functional('abc', /c/); // -> true
 *
 * // With pos and sticky
 * XRegExp.tests--functional('abc', /c/, 0, 'sticky'); // -> false
 * XRegExp.tests--functional('abc', /c/, 2, 'sticky'); // -> true
 */
...
/**
 * Fixes browser bugs in the native `RegExp.prototype.tests--functional`. Calling `XRegExp.install('natives')`
